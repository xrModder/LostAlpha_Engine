...
__published:
	...
	__property Graphics::TColor HighlightColor = {read=FHighlightColor, write=SetHighlightColor, default=-2147483634};
	__property Graphics::TColor HighlightBkColor = {read=FHighlightBkColor, write=SetHighlightBkColor, default=-2147483635};
