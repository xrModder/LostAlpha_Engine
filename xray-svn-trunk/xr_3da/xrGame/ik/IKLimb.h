...
#endif	
private:
		static	void 	__stdcall	BonesCallback0		( CBoneInstance* B );
		static	void 	__stdcall	BonesCallback1		( CBoneInstance* B );
		static	void 	__stdcall	BonesCallback2		( CBoneInstance* B );
		static	void 	__stdcall	get_matrix		( CBoneInstance* B );
