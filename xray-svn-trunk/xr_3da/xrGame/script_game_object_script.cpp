...
void CScriptGameObject::script_register(lua_State *L)
{
	...
	//			value("sound_played",				int(GameObject::eOnSoundPlayed)),
				...
				value("on_button_press",				int(GameObject::eOnButtonPress)),
				value("on_button_release",				int(GameObject::eOnButtonRelease)),
				value("on_button_hold",				int(GameObject::eOnButtonHold)),
				value("on_move_to_slot",				int(GameObject::eOnMoveToSlot)),
				value("on_move_to_belt",				int(GameObject::eOnMoveToBelt)),
				value("on_move_to_ruck",				int(GameObject::eOnMoveToRuck)),
