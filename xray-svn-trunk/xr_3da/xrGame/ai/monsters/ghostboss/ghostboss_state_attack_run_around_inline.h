...
#define CStateGhostBossAttackRunAroundAbstract CStateGhostBossAttackRunAround<_Object>
...
CStateGhostBossAttackRunAroundAbstract::CStateGhostBossAttackRunAround(_Object *obj) : inherited(obj)
{
}

TEMPLATE_SPECIALIZATION
void CStateGhostBossAttackRunAroundAbstract::initialize()
{
...
TEMPLATE_SPECIALIZATION
void CStateGhostBossAttackRunAroundAbstract::execute()
{
...
TEMPLATE_SPECIALIZATION
bool CStateGhostBossAttackRunAroundAbstract::check_start_conditions()
{
	return true;
}

TEMPLATE_SPECIALIZATION
bool CStateGhostBossAttackRunAroundAbstract::check_completion()
{
...
#undef CStateGhostBossAttackRunAroundAbstract
