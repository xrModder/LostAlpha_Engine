...
#define CStateGhostBossAttackGraviAbstract CStateGhostBossAttackGravi<_Object>

#define GOOD_DISTANCE_FOR_GRAVI 6.f

TEMPLATE_SPECIALIZATION
CStateGhostBossAttackGraviAbstract::CStateGhostBossAttackGravi(_Object *obj) : inherited(obj)
{
}

TEMPLATE_SPECIALIZATION
void CStateGhostBossAttackGraviAbstract::initialize()
{
...
TEMPLATE_SPECIALIZATION
void CStateGhostBossAttackGraviAbstract::execute()
{
	switch (m_action) {
		/************************/
...
TEMPLATE_SPECIALIZATION
void CStateGhostBossAttackGraviAbstract::critical_finalize()
{
...
TEMPLATE_SPECIALIZATION
bool CStateGhostBossAttackGraviAbstract::check_completion()
{
...
#undef CStateGhostBossAttackGraviAbstract