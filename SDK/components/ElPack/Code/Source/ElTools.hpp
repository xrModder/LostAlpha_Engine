...
extern PACKAGE AnsiString __fastcall GetTempFile(AnsiString SDir);
...
extern PACKAGE AnsiString __fastcall EnsureValidFileName(AnsiString PathName, AnsiString FileName);
