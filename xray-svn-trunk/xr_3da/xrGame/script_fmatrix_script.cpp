...
void CScriptFmatrix::script_register(lua_State *L)
{
	...
	[
		class_<Fmatrix>("matrix")
			...
			.def("mul_43",							(Fmatrix & (Fmatrix::*)(const Fmatrix &, float))(&Fmatrix::mul_43),															return_reference_to(_1))
			.def("mul_43",							(Fmatrix & (Fmatrix::*)(float))(&Fmatrix::mul_43),																			return_reference_to(_1))
